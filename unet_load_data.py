...
# Define directories
positive_images_dir = r'archive\Positive\Images'
positive_masks_dir = r'archive\Positive\Masks'
...
# Load positive data
positive_images, positive_masks = load_positive(positive_images_dir, positive_masks_dir)

# Load negative data
negative_images, negative_masks = load_negative(negative_images_dir, negative_masks_dir)
